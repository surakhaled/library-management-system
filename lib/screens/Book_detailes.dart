...
import 'package:library_management_system/provider/auth.dart';
...
class BookDetailes extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    //final bok =Provider.of<products>(context,listen: false);
                ...
                Column(
                  children: [
                    ...
                    RaisedButton(
                      ...
                      onPressed:(){
                        cartt.additem(_editedProduct.id, _editedProduct.price.toDouble(),_editedProduct.name);
                        ...
                        Scaffold.of(context).showSnackBar(
                          SnackBar(
                            ...
                            action: SnackBarAction(
                              label: 'undo',
                              onPressed: () {
                                cartt.removesingleitem(_editedProduct.id);
                              },
                            ),
                          ),
                        );
