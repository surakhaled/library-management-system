...
import 'package:library_management_system/screens/search_all_books_page.dart';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text(lan.getTexts("My Books Paid"),style: TextStyle(fontFamily: "Pacifico",fontWeight: FontWeight.bold),),
          actions: [
            Row(
              children: [
                IconButton(
