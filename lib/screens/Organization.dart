    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text(lan.getTexts("Organization"),style: TextStyle(fontFamily: "Pacifico",fontWeight: FontWeight.bold),),
        ),
        body: Stack(
          children:[
            Image(
            ...
            Center(
              child: Row(
                ...
                children: [
                  ...
                  RaisedButton(
                    child: Text(lan.getTexts('Free Books'),style: TextStyle(fontSize:30,fontFamily: "Pacifico",fontWeight: FontWeight.bold ),
                    ),
                    onPressed: () =>
                  ...
                  RaisedButton(
                    child: Text(lan.getTexts('Paid Books'),
