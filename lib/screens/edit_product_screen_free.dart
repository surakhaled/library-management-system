...
import 'package:library_management_system/models/book_free.dart';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: _editedProduct.id != null
              ? Text(lan.getTexts("Edit Books Free "),
            style: TextStyle(fontFamily: "Pacifico",fontWeight: FontWeight.bold),
          )
              : Text(lan.getTexts("Add Book Free"),
            style: TextStyle(fontFamily: "Pacifico",fontWeight: FontWeight.bold),
          ),
          actions: [
            Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration:InputDecoration(suffixIcon:Icon(Icons.picture_as_pdf),labelText:"Pdf",labelStyle:TextStyle(
                          color: Th.getColor("BW54"),
                        )),
                        textInputAction: TextInputAction.next,
                        style: TextStyle(color: Th.getColor("BW")),
                        ...
                        validator: (value) {
                          if (value.isEmpty) {
                            return lan.getTexts("Please Select A Pdf.");
                          }
                          return null;
                        },
                        onSaved: (value) {
