          ...
          child: Column(
            children: [
              AppBar(
                ...
                title: Text(lan.getTexts("Iqra Library"),
              ...
              ListTile(
                ...
                title: Text(lan.getTexts('My Account'),style: TextStyle(color:Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),),
                onTap: () {
                },
              ),
              ListTile(
                leading: Icon(Icons.search,color:Th.getColor("secondaryColor"),),
                title: Text(lan.getTexts('the Search'),style: TextStyle(color:Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),),
              ...
              ListTile(
                ...
                title: Text(lan.getTexts('LIBRARY'),style: TextStyle(color:Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),),
                onTap: () => Navigator.of(context).pushReplacementNamed('/'),
              ),
              ListTile(
                leading: Icon(Icons.work_rounded,color: Th.getColor("secondaryColor")),
                title: Text(lan.getTexts('ORDERS'),
              ...
              ListTile(
                ...
                title: Text(lan.getTexts('ABOUT US'),style: TextStyle(color: Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),),
                onTap: ()=>Navigator.of(context)
                    .pushNamed(AboutUs.routename),
              ),
              ListTile(
                  leading: Icon(Icons.exit_to_app,color:Th.getColor("secondaryColor"),),
                  title: Text(lan.getTexts('LOUGOUT'),style: TextStyle(color: Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),),
                  onTap: () {
              ...
              Container(
                ...
                padding: EdgeInsets.only(top: 20,right: 22),
                child:Text(lan.getTexts('   Choose Your Prefer Theme.'),
                  style: TextStyle(color:Th.getColor("secondaryColor"),fontWeight:FontWeight.bold),
                ),
              ),
              Padding(
